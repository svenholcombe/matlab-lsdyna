classdef ELEMENT_DISCRETE < lsdyna.keyword.card
    %lsdyna.keyword.ELEMENT_DISCRETE
    
    properties (Constant)
        KeywordMatch = "ELEMENT_DISCRETE";
        LineDefinitions = ...
            lsdyna.keyword.utils.cardLineDefinition("ELEMENT_DISCRETE");
    end
    ...
    %% CONSTRUCTOR
    methods
        function newCard = ELEMENT_DISCRETE(basicCard)
